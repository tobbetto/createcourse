...
/**
 * Strings for component 'local_createcourse'.
 *
...
$string['courseshortnameincremented'] = 'Course shortname incremented';
...
$string['shortnamefullnameerror'] = 'The shortname {$a->shortname} and fullname suffix \'{$a->fullname}\' to be created do not match';
...
$string['updatemode_help'] = 'If you allow courses to be updated, you also have to tell the local_createcourse what to update the courses with.';
...
$string['uploadcourses'] = '💪 Auto create courses';
